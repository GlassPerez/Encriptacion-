...
namespace ctrlArchivos.Modelo
{
    public class Expediente
    {
        ...
        public void muestraexpediente(DropDownList clasificacion)
        {
            ...
            if (leer != null)
            {
                while (leer.Read())
                {
                    ...
                    formato_Soporte = leer[20] + "";
                    plazo_conservacion_exp = Convert.ToInt32( leer[21] + "");
                    tipo_exp = leer[22] + "";
                    destino_final_exp = leer[23] + "";
                    valores_secundarios_exp = leer[24] + "";
                    ...
                    System.Windows.Forms.MessageBox.Show(Clasificación);
                }
            }
        ...
        public void buscarIdCorrespondiente(DropDownList ddlnombre, DropDownList ddlid)
        {
            ...
            ddlid.SelectedIndex = ddlnombre.Items.IndexOf(ddlnombre.Items.FindByValue(ddlnombre.Text));
        }
        ...
        public int actualizarexpediente(DropDownList clasiexpediente)
        {
            string consulta = "Update expediente set no_exp="
                + no_exp + ",año=" + año + ", id_unid_admva_resp=" +
                "'" + id_unid_admva_resp + "',id_area_prod= '" + id_area_prod + "',id_resp_exp= '" + id_resp_exp + "',resumen_exp= '" + resumen_exp + "',asunto_exp ='" + asunto_exp + "',funcion_exp='" + funcion_exp + "',acceso_exp= '" + acceso_exp + "', val_prim_exp= '" + val_prim_exp + "',fec_ext_ini_exp= " +
                "'" + fec_ext_ini_exp + "',fec_ext_fin_exp= '" + fec_ext_fin_exp + "',no_legajo_exp= " +
                no_legajo_exp + ",no_fojas_exp= " + no_fojas_exp + ",vinc_otro_exp= " +
                "'no',id_exp_vincd= 'NINGUNO',formato_soporte= '" + formato_Soporte + "',plazo_conservacion_exp= " +
                plazo_conservacion_exp + ",tipo_exp= " +
                "'" + tipo_exp + "',destino_final_exp= '" + destino_final_exp + "', valores_secundarios_exp='" + valores_secundarios_exp + "',id_ubic_topog= '" + id_ubic_topog + "',IdEdificio= " +
                ...
                "'" + fecha_alta_exp + "',Idcapturista_exp= " +
