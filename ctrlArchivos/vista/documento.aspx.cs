    ...
    public partial class documento : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                medium.combousuario(DropDownList3);
                medium.combousuario(DropDownList4);
                medium.combousuario(DropDownList5);
        ...
        protected void btnAgregarDoc_Click(object sender, EventArgs e)
        {
            ...
            medium.iddelegado = DropDownList5.SelectedValue;
